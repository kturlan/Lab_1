...
music_folder = "\\Users\\User\\Documents\\PP2\\7.lab\\music"
...
pygame.display.set_caption("Currents")
clock = pygame.time.Clock()

background = pygame.image.load(os.path.join("musicelements", "background.png"))
...
playb = pygame.image.load(os.path.join("musicelements", "play.png"))
pausb = pygame.image.load(os.path.join("musicelements", "pause.png"))
nextb = pygame.image.load(os.path.join("musicelements", "next.png"))
prevb = pygame.image.load(os.path.join("musicelements", "back.png"))
